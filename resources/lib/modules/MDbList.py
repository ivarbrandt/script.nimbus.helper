...
#             )
#             if dt.datetime.now() - last_updated_date < dt.timedelta(days=3):
#                 return ratings
#         return None
...
#         try:
#             recent_days = int(
#                 xbmc.getInfoLabel("Skin.String(nimbus_digital_release_window)") or "7"
#             )
#             expired_days = int(
#                 xbmc.getInfoLabel("Skin.String(nimbus_digital_expired_window)") or "14"
#             )
#         except ValueError:
#             recent_days = 7
#             expired_days = 14
